defmodule ProtobufGenerate.Plugins.Message do
  ...
  def generate(%Context{} = ctx, %Google.Protobuf.DescriptorProto{} = desc) do
    ...
    nested_msgs = gen_nested_msgs(ctx, desc)
  ...
  defp get_field(ctx, %Google.Protobuf.FieldDescriptorProto{} = field_desc, nested_maps, oneofs) do
  ...
  defp field_type_name(
         ctx,
         %Google.Protobuf.FieldDescriptorProto{type_name: type_name} = field_desc
       ) do
  ...
  defp add_field_opts_if_present(opts, %Google.Protobuf.FieldDescriptorProto{options: field_opts}) do
    opts =
  ...
  defp add_enum_to_opts(opts, %Google.Protobuf.FieldDescriptorProto{type: type}) do
  ...
  defp add_default_value_to_opts(opts, %Google.Protobuf.FieldDescriptorProto{
